...
# Import target "gdcmclean" for configuration "Release"
set_property(TARGET gdcmclean APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(gdcmclean PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/gdcmclean.exe"
  )

list(APPEND _IMPORT_CHECK_TARGETS gdcmclean )
list(APPEND _IMPORT_CHECK_FILES_FOR_gdcmclean "${_IMPORT_PREFIX}/bin/gdcmclean.exe" )
